...
const SKILL_CMD = 'npx skills add jizhoutang10thglobal/wordspace-next --skill schema-1-authoring'

// AI 接入：把「让 AI 按 Schema 写 Wordspace 文档」交到用户手里的两条路。
// 方式一 复制 Prompt——零安装，任何对话式 AI 都能用；
// 方式二 安装 Skill——装一次，coding agent 此后写 Wordspace 文档时自动遵守 Schema。
    ...
    <div className="ag-scroll">
      <div className="ag-page">
        ...
        <section className="ag-section">
          <div className="ag-label">方式一 · 复制 Prompt</div>
          <div className="ag-card">
            <div className="ag-way-head">
              <span className="ag-way-ico"><ClipboardList size={16} /></span>
              <div className="ag-way-text">
                <div className="ag-way-title">粘给任何对话式 AI</div>
                <div className="ag-way-hint">
                  Claude、ChatGPT、Gemini……零安装。Prompt 就是完整的《Schema #1 创作指南》。
                </div>
              </div>
              <button
        ...
        {/* 方式二：安装 Skill */}
        <section className="ag-section">
          <div className="ag-label">方式二 · 安装 Skill</div>
          <div className="ag-card">
            <div className="ag-way-head">
              <span className="ag-way-ico"><TerminalSquare size={16} /></span>
              <div className="ag-way-text">
            ...
            <ol className="ag-steps">
              <li>在你的项目目录里跑上面这条命令（会从 Wordspace 官方仓库安装）</li>
