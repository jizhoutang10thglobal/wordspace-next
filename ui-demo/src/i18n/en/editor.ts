...
export default {
  ...
  // Paged typography toolbar (U5)
  presetGbOfficial: 'GB Official',
  presetThesis: 'Thesis',
  presetBusiness: 'Business',
  presetApa: 'APA',
  presetMla: 'MLA',
  presetsBuiltin: 'Standard presets',
  presetsCustom: 'Custom',
  presetCustom: 'Custom',
  presetCustomBasedOn: 'Custom · based on {name}',
  font_fangsong: 'FangSong',
  font_songti: 'Song',
  font_xiaobiaosong: 'Xiaobiaosong',
  font_heiti: 'Hei',
  font_kaiti: 'Kai',
  font_yahei: 'YaHei',
  ...
  font_arial: 'Arial',
  zihao_chuhao: 'Chuhao',
  zihao_xiaochu: 'Xiaochu',
  zihao_yihao: 'Yihao',
  zihao_xiaoyi: 'Xiaoyi',
  zihao_erhao: 'Erhao',
  zihao_xiaoer: 'Xiaoer',
  zihao_sanhao: 'Sanhao',
  zihao_xiaosan: 'Xiaosan',
  zihao_sihao: 'Sihao',
  zihao_xiaosi: 'Xiaosi',
  zihao_wuhao: 'Wuhao',
  zihao_xiaowu: 'Xiaowu',
  zihao_liuhao: 'Liuhao',
  zihao_xiaoliu: 'Xiaoliu',
  zihao_qihao: 'Qihao',
  zihao_bahao: 'Bahao',
  lineHeightSingle: 'Single',
  lineHeightDouble: 'Double',
  lineHeightFixed: 'Fixed {pt} pt',
  ...
  alignAria: 'Alignment',
  // Page setup modal sections (U6)
  secPage: 'Page',
  secTypography: 'Typography',
  secHeadings: 'Headings',
  unitMm: 'mm',
  unitInch: 'inch',
  unitAria: 'Margin unit',
  ...
  presetNamePlaceholder: 'Custom preset name',
  presetDupError: 'Name already exists',
  presetEmptyError: 'Enter a name',
  customPresetCount: '{n} custom preset(s) saved',
