...
export default {
  ...
  paradigmFlow: 'Flowing doc',
  paradigmFlowDesc: 'Notion-style blocks, no pagination (Schema 1)',
  paradigmPaged: 'Paged doc',
  paradigmPagedDesc: 'Word-style pagination + standardized layout (Schema 2)',
  blankPagedDoc: 'Blank paged doc',
  blankPagedDocDesc: 'A4 sheet, GB Official preset',
