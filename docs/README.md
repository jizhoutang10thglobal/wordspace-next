...
| 位置 | 放什么 |
|---|---|
| [`../specs/`](../specs/) | **功能 Feature Board**：每个功能模块一个 `F##-slug.md`（~100 字 + 指向 demo）+ 自动生成的看板（想法 / 待开发 / 开发中 / 已完成）+ 每个功能的决策（spec 里的「备注」段）。新功能 / bug 在这开 `F##`；进度看自动发布的看板。 |
...
| [`../ui-demo/`](../ui-demo/) | Wendi 的可运行前端 / UX **demo** + 产品文档原件。讨论参考，**领先于正式产品，≠ 正式实现**。 |
