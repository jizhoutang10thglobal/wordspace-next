...
// 无 electron import,node/vitest 可直接 require(S1 教训:纯逻辑与 electron 解耦)。
// 一份共用:U1 palette 自检、U4 chrome 亮度门、U7 对比度门,别各写各的。
...
module.exports = { parseColor, relativeLuminance, contrastRatio };
