...
开发方式：spec（取材自 projectx Feature Board，见 `docs/projectx-context.md`）→ AI 实现过全部门禁（vitest 快门 + 真 Electron e2e + 人锁 VA 可见验收 + 变异自检）→ PR → 合并自动发版。
...
- **上游 context**：产品愿景、Feature Board、spec 流向约定见 `docs/projectx-context.md`。
